...
import { getEditais, getEditaisFavoritos, getEditaisId, getUserLogin, removeEditalFavorito } from "@/lib/api";
                  ...
                  {filteredCards.map((card, index) => (
                    ...
                    >
                      <div className="flex ml-auto mb-2">
                        ...
                        (<button className="text-[#37B7C3]" onClick={() => handleRemoveFavorite(card)}>
                          <FaStar />
                        </button>)
                        :
              ...
              <div className="ml-12 mt-12">
                ...
                <div className="flex items-center gap-x-2">
                  ...
                  <div className="gap-x-10 gap-y-[2vh] flex flex-col">
                    ...
                    <div className="flex flex-row w-full justify-center gap-x-[2vw] mt-10">
