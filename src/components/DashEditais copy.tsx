    ...
    <>
      <div className="min-h-screen">
        ...
        <div className="w-full mb-44">
          <section className="relative flex flex-col items-center min-h-[400px]">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center gap-y-7">
              ...
              <Link href="/search" className=" flex justify-center leading-none border-none outline-none rounded-xl bg-[#088395] px-4 py-3 text-white font-semibold text-lg items-center cursor-pointer mb-6 hover:shadow-button-Home-hover-focus focus:shadow-button-Home-hover-focus">
        ...
        <div className="w-full mt-44">
          ...
          <div className="text-black top-0 left-0 w-full h-full flex flex-row justify-center gap-x-7 my-[7vh] items-start bg-slate-500">
            <div className="flex flex-col gap-y-5">
              <p>INFORMAÇÕES</p>
              <div>
                <div className="flex flex-col gap-y-3">
                  <Link href={'/'}>Pagina Inicial</Link>
                  <Link href={'/'}>Editas Disponíveis</Link>
            ...
            <div className="flex flex-col gap-y-3">
              <p>CONTATO</p>
              <div>
                <p>Queremos ouvir de você! Envie suas perguntas,</p>
                <p>comentários ou sugestões.</p>
              </div>
              <p>Envie sua Mensagem</p>
              <p>Ou contate-nos por outros meios:</p>
              <p>Contato@EditalView.upe.br</p>
              <div className="flex flex-row"><FaWhatsapp /> <FaInstagram /></div>
            </div>
          </div>
          <div className="w-[100vw] h-[6vh] bg-[#088395]"/>
        </div>
      </div>
    </>
  );
